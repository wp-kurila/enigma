					...
					<div className={styles.container} data-tag="popup">
						...
						<div className={styles.popup_content}>
							<div className={styles.images_list_block}>
								<button onClick={() => handleScroll()} className={styles.arrow_wrapper} disabled={activeImage === 0}>
									<div className={cn(styles.arrow, styles.arrow_top)} />
								</button>
								...
								<button
									...
									disabled={activeImage === imagesRef.current.length - 1}
								>
							...
							<div className={styles.main_image_wrapper}>
								<div
									...
									style={{ backgroundImage: `url(${getImageLink(images[activeImage], '.jpg', imagesFolder)})` }}
								/>
							</div>
