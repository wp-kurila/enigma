...
const Nav: React.FC<Props> = (props: Props): React.ReactElement => {
	...
	return (
		<nav className={navCls} onClick={handleClick}>
			<a className={styles.nav__elem} data-tag='nav_elem' data-to='about'>{t('nav__about')}</a>
			<a className={styles.nav__elem} data-tag='nav_elem' data-to='roomsLayout'>{t('nav__layouts')}</a>
			<a className={styles.nav__elem} data-tag='nav_elem' data-to='questions'>FAQ</a>
			<a className={styles.nav__elem} data-tag='nav_elem' data-to='contacts'>{t('nav__contacts')}</a>
